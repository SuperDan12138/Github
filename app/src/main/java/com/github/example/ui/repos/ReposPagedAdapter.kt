...
class ReposPagedAdapter : PagingDataAdapter<Repo, RepoPagedViewHolder>(diffCallback) {
    ...
    private val clickLiveData: MutableLiveData<String> = MutableLiveData()
    private val longClickLiveData: MutableLiveData<Repo> = MutableLiveData()
    ...
    override fun onBindViewHolder(holder: RepoPagedViewHolder, position: Int) {
        holder.binds(getItem(position)!!, position, this.clickLiveData, this.longClickLiveData)
    }
    ...
    fun getItemLongClickEvent(): LiveData<Repo> {
        return this.longClickLiveData
    }
...
class RepoPagedViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
    ...
    private val clRoot: ConstraintLayout = view.findViewById(R.id.clRoot)
    ...
    fun binds(data: Repo, position: Int, observer: MutableLiveData<String>, longClickObserver: MutableLiveData<Repo>) {
        ...
        clRoot.setOnLongClickListener {
            longClickObserver.postValue(data)
            true
        }
